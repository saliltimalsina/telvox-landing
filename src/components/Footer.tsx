...
const SOCIALS = [
  { href: "https://x.com/telvox", label: "X", icon: XIcon },
  {
    href: "https://www.instagram.com/telvox.ai",
    label: "Instagram",
    icon: InstagramIcon,
  },
  {
    href: "https://www.linkedin.com/company/telvoxai/",
    label: "LinkedIn",
    icon: LinkedinIcon,
  },
];
    ...
    <footer className="relative overflow-hidden px-5 pt-4">
      <div className="mx-auto max-w-[1200px]">
            ...
            {SOCIALS.map((s) => {
              ...
              return (
                <a
                  ...
                  rel="noopener"
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-black/10 text-[#171034] transition-colors hover:bg-black/[.04]"
                >
                  <Icon size={16} />
                </a>
              );
        ...
        {/* Oversized wordmark watermark, blended into the page at the bottom
            ...
            reserving blank layout space for it. */}
        <div className="relative -mb-28 select-none overflow-hidden" aria-hidden>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/brand/logo.webp"
            alt=""
